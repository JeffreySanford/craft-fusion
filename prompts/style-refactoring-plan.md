...
- Red: #B22234 (also used for main-stage border)
- Orange: #FF7F00 (used for sidebar border)
- Navy: #002868
- Gold: #FFD700
- White: #FFFFFF
...
- **Core Layout Components**
  ...
  - ✅ Test container layouts with border visualization (red for main-stage, orange for sidebar)
...
- ✅ Added red border to main-stage container for easier visual distinction
- ✅ Added orange border to sidebar container for layout debugging
- ✅ Enhanced footer integration with layout service via isFooterExpanded$ Observable
...
- Outline of components affected by style refactoring.
- Next steps for color token alignment.
