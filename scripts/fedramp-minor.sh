...
PROFILES=(standard ospp pci-dss cusp medium-high rev5) # medium-high & rev5 are placeholders for future FedRAMP Rev 5
...
echo -e "${WHITE}This will run standard, ospp, pci-dss, cusp, medium-high, and rev5 scans${NC}"
echo
