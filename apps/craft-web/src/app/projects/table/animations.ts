...
export const flyIn = trigger('flyIn', [
  transition(':enter', [
    animate(
      '800ms cubic-bezier(0.215, 0.610, 0.355, 1.000)',
      keyframes([
  ...
  transition(':leave', [
    animate('400ms ease-out', keyframes([style({ transform: 'translateX(0)', opacity: 1, offset: 0 }), style({ transform: 'translateX(100%)', opacity: 0, offset: 1.0 })])),
  ]),
]);
