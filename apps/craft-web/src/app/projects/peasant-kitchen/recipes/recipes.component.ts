  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      if (!this.loaded || this.recipes.length === 0) {
        ...
        this.recipes = [
          { id: 1, name: 'Classic Beef Stew', description: 'A hearty beef stew with root vegetables', countryCode: 'FR', countryName: 'France', servingSize: '6 servings', url: 'classic-beef-stew', ingredients: ['2 lbs beef chuck', '4 carrots', '2 onions', '3 potatoes'], directions: ['Brown the beef', 'Add vegetables and broth', 'Simmer for 2 hours'] },
          { id: 2, name: 'Simple Pasta Carbonara', description: 'Traditional Roman pasta dish', countryCode: 'IT', countryName: 'Italy', servingSize: '4 servings', url: 'pasta-carbonara', ingredients: ['1 lb spaghetti', '8 oz pancetta', '4 egg yolks', '1 cup Pecorino Romano'], directions: ['Cook pasta', 'Fry pancetta', 'Mix eggs and cheese', 'Toss all together while hot'] }
        ];
        this.loaded = true;
        this.updatePaginatedRecipes();
